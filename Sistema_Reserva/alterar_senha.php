...
<div id="box">
    <form action="./php/alterar_senha1.php" id="myform-search" method="post" autocomplete="off">
      <h1>Alteração de Senha<span>Escolha uma boa!</span></h1>
      <p>
        <input type="email" placeholder="Email" name="email" id="email" class="password">
        <input type="password" placeholder="Nova Senha" name="nova_senha" id="nova_senha" class="password">
        <input type="password" placeholder="Confirme a Nova Senha" name="confirmar_senha" id="confirmar_senha" class="password">
